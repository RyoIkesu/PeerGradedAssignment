...
Then they were filtered using a median filter and a 3rd order low 
...
Variables transformation process)
To make the variables above more readable and understandable, I transformed the
raw variables in a way mentioned below;

"t" in the head of variables    → "time."
"f" in the head of variables    → "freq."
"Acc"                           → "Acceleration"
"Gyro"                          → "Gyroscopic"
"Mag"                           → "Magnitude"
"-std()"                        → "S.D."
